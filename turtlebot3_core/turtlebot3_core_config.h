...
void gpioCallback(const bot3gpio::Request & req, bot3gpio::Response & res); //kccistc
...
ros::ServiceServer<bot3gpio::Request, bot3gpio::Response> gpio_server("bot3_gpio",&gpioCallback); //by kccistc
/*******************************************************************************
* Publisher
*******************************************************************************/
